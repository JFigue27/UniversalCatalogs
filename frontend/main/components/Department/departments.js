  ...
  render() {
    return (
      <>
        ...
        <Dialog open={!!this.state.departmentDialog} onClose={this.closeDialog} draggable title='Department'>
          {dialog => {
            return !this.state.isLoading && <Department dialog={dialog} data={this.state.departmentDialog} />;
          }}
        </Dialog>
