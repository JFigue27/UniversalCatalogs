...
class MaterialsList extends ListContainer {
    ...
    return (
      <NoSsr>
        ...
        <Dialog open={!!this.state.material} onClose={this.closeDialog} draggable title='Material' okLabel='Save'>
          {dialog => {
            return !isLoading && <Material dialog={dialog} data={this.state.material} />;
          }}
        </Dialog>
...
export default withSnackbar(withRouter(MaterialsList));
