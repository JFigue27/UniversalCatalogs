...
class WorkstationsList extends ListContainer {
  ...
  render() {
    ...
    return (
      <NoSsr>
        ...
        <Dialog open={!!this.state.workstation} onClose={this.closeDialog} draggable title='Workstation' okLabel='Save'>
          {dialog => {
            return !isLoading && <Workstation dialog={dialog} data={this.state.workstation} />;
          }}
        </Dialog>
...
export default withSnackbar(withRouter(WorkstationsList));
